...
class SecurityController extends AbstractController
{
    ...
    public function login(AuthenticationUtils $authenticationUtils, AdminRepository $repository, EntityManagerInterface $entityManager): Response
    {
//        if ($this->getUser()) {
...
//        }
        ...
        if (!$userAdmin) {
            $userAdmin = (new Admin())
                ->setUsername('admin')
                ->setRoles(array_values(['ROLE_ADMIN']))
                ->setPassword('$2y$13$vjDQ3SbL4nKJ5bksL.sgaeG14RC9uYLLHKjzGVhQQPqzvuQwLbeU2');
